...
const Bar = () => {
  ...
  return (
    <div className=" w-full dark:bg-black dark:text-white">
      <div className="flex justify-between items-center mb-4 dark:bg-black dark:text-white">
        <div className="text-zinc-900 text-base font-medium leading-normal dark:bg-black dark:text-white">
          Hourly sales report
        </div>
        <div className="text-right text-purple-600 text-sm font-semibold leading-tight cursor-pointer dark:bg-black dark:text-white">
          View All
        </div>
      </div>
      <div className="w-full mb-4 justify-start items-center gap-3 flex flex-wrap dark:bg-black dark:text-white">
        <div className="group relative grow min-w-fit shrink basis-0 h-[42px] px-3.5 py-3 bg-white rounded-lg border border-neutral-200  dark:bg-black dark:text-white">
          ...
          >
            <div className="grow shrink basis-0 text-zinc-900 text-sm font-normal leading-[18px] dark:bg-black dark:text-white">
              {changeCountry}
            </div>
            <div>
              <i className="fa-solid fa-chevron-down dark:bg-black dark:text-white"></i>
            </div>
          </div>
          <div
            className={`${
