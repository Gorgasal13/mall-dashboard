...
const Column = () => {
  return (
    <div>
      <div className="h-max w-full p-6 relative bg-white rounded-xl dark:bg-black dark:text-white">
        ...
        <div className=" mt-8 w-full dark:bg-black dark:text-white">
          <ChartComponent
            id="column-sparkLine"
            width="100%"
            height="100%"
        ...
        <div className="text-red-600 text-xs font-normal leading-[18px] text-center mt-4 dark:bg-black dark:text-white">
