...
export let topSellingAndGrossingItems = [
  {
    ...
    items: [
      {
        img: pl,
        text: "ENRIVA Men's 200m Water Resistant Watches",
        money: "$ 2.302,00",
        percentage: "-0,5%",
      ...
      {
        img: pl1,
        text: "Men's Driver XL Leather Brown Dial Watches",
        money: "$ 2.302,00",
        percentage: "+2,5%",
        color: "text-lime-500",
      },
      {
        img: pl2,
        text: "Samsung Galaxy A52 Mini Bronze SmartPhone",
        money: "$ 2.302,00",
        percentage: "-0,5%",
        color: "text-orange-600",
      },
  ...
  },
  {
    ...
    items: [
      {
        img: pl3,
        text: "Samsung Galaxy S24 Ultra Bronze SmartPhone",
        money: "$ 2.302,00",
        percentage: "+2,5%",
        color: "text-lime-500",
      },
      {
        img: pl4,
        text: "APPLE IPHONE 13 Mini 128Gb Pink IPhone",
        money: "$ 2.302,00",
        percentage: "-0,5%",
        color: "text-lime-500",
      },
      {
        img: pl5,
        text: "APPLE IPHONE 14 Mini 128Gb Midnight IPhone",
        money: "$ 2.302,00",
        percentage: "-0,5%",
        color: "text-orange-600",
      },
...
export let multilocation = [
  {
    ...
    cities: [
      {
        city: "Tbilisi",
        multilocation: ["Rustaveli", "Marjanishvili", "Gldani", "Sanzona"],
      },
      {
        city: "Batumi",
        multilocation: ["Airport", "Hospital"],
      },
      {
        city: "Gori",
        multilocation: ["Airport", "Hospital"],
